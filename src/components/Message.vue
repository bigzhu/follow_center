<template>
  <div :id="'id_'+ message.id" class="ui fluid card message-bz">
    ...
    <div class="like-bz">
      ...
      <a @click="anki" class="hidden-bz anki-bz">
